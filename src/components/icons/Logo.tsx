...
const Logo: React.FC<LogoProps> = ({ type }) => {
    const [isIndexLogo, setIsIndexLogo] = React.useState(false);
        ...
        <LogoContainer isIndexLogo={isIndexLogo}>
            <svg viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                ...
                <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                    d="M0 6C0 2.68629 2.68629 0 6 0H24C27.3137 0 30 2.68629 30 6V24C30 27.3137 27.3137 30 24 30H6C2.68629 30 0 27.3137 0 24V6ZM5 9C5 6.79086 6.79086 5 9 5H21C23.2091 5 25 6.79086 25 9V21C25 23.2091 23.2091 25 21 25H9C6.79086 25 5 23.2091 5 21V9Z"
                />
            </svg>
        </LogoContainer>
    );
